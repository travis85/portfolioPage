        ...
        <div className=" mt-20  space-y-20" >
            ...
            <div className="card mb-3 shadow-xl mr-[20%] ml-2 rounded-xl bg-gradient-to-r from-blue-500 to-transparent" >
                <div className="row g-0 ">
                    ...
                    <div className="col-md-8">
                        <div className="card-body">
                            <a href="https://react-to-do-754f3.web.app/"><h2 className="flex justify-center italic font-semibold text-4xl text-blue-500 hover:-translate-y-1 hover:scale-110 hover:animate-bounce">To-do-List</h2></a>
                            <div className="flex justify-center mt-20 text-2xl">
